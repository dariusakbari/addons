...
class ResConfigSettings(models.TransientModel):
    ...
    gte_mail_ready = fields.Boolean(compute="_compute_gte_mail_diag")
    gte_mail_diag = fields.Html(compute="_compute_gte_mail_diag",
                                string="Construction Mail Readiness")

    @api.depends_context("uid")
    def _compute_gte_mail_diag(self):
