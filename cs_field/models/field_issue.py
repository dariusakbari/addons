...
class GteFieldIssue(models.Model):
    ...
    distribution_ids = fields.Many2many("res.partner", "cs_fi_distribution_rel",
                                        string="Distribution")
    ...
    rfi_id = fields.Many2one("cs.rfi", string="Released RFI", readonly=True,
                             copy=False)
    ...
    def create(self, vals_list):
        for vals in vals_list:
            if vals.get("name", "New") == "New" and vals.get("project_id"):
                ...
                vals["name"] = self._cs_next_number(project, "cs.field.issue", "FI")
